class BooksController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @book.update(book_params)
        format.html { redirect_to autor_book_path(@autor.id, @book.id), notice: "Book was successfully updated." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to autor_books_path(@autor.id), notice: "Book was successfully destroyed." }
